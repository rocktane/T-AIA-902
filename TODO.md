...
- [ ] **Tuning des parametres en mode user** : permettre a l'utilisateur de modifier `epsilon`, `gamma`, `learning_rate` (pas seulement le nombre d'episodes)
- [ ] **Nb d'episodes de test en mode temps limite** : demander le nombre d'episodes de test a l'utilisateur (actuellement hardcode a 10)
